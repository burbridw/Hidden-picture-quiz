...
const gameImageBoxes = document.querySelectorAll(".image-box")
const quizImageBoxes = document.querySelectorAll(".quiz-image-box")
...
const selectObj = {
    ...
    "autumnforest" : ["./images/autumnforest/img1.png","./images/autumnforest/img2.png", "./images/autumnforest/img3.png", "./images/autumnforest/img4.png", "./images/autumnforest/img5.png", "./images/autumnforest/img6.png", "./images/autumnforest/img7.png", "./images/autumnforest/img8.png", "./images/autumnforest/img9.png", "./images/autumnforest/img10.png", "./images/autumnforest/img11.png", "./images/autumnforest/img12.png", "./images/autumnforest/img13.png", "./images/autumnforest/img14.png", "./images/autumnforest/img15.png", "./images/autumnforest/img16.png", "./images/autumnforest/img17.png", "./images/autumnforest/img18.png", "./images/autumnforest/img19.png", "./images/autumnforest/img20.png", "./images/autumnforest/img21.png", "./images/autumnforest/img22.png", "./images/autumnforest/img23.png", "./images/autumnforest/img24.png", "./images/autumnforest/img25.png", "./images/autumnforest/img26.png", "./images/autumnforest/img27.png", "./images/autumnforest/img28.png", "./images/autumnforest/img29.png", "./images/autumnforest/img30.png", "./images/autumnforest/img31.png", "./images/autumnforest/img32.png"], 
    "goodmorning" : ["./images/goodmorning/img1.png","./images/goodmorning/img2.png", "./images/goodmorning/img3.png", "./images/goodmorning/img4.png", "./images/goodmorning/img5.png", "./images/goodmorning/img6.png", "./images/goodmorning/img7.png", "./images/goodmorning/img8.png", "./images/goodmorning/img9.png", "./images/goodmorning/img10.png", "./images/goodmorning/img11.png", "./images/goodmorning/img12.png", "./images/goodmorning/img13.png", "./images/goodmorning/img14.png", "./images/goodmorning/img15.png", "./images/goodmorning/img16.png", "./images/goodmorning/img17.png", "./images/goodmorning/img18.png", "./images/goodmorning/img19.png", "./images/goodmorning/img20.png", "./images/goodmorning/img21.png", "./images/goodmorning/img22.png", "./images/goodmorning/img23.png", "./images/goodmorning/img24.png", "./images/goodmorning/img25.png", "./images/goodmorning/img26.png", "./images/goodmorning/img27.png", "./images/goodmorning/img28.png", "./images/goodmorning/img29.png", "./images/goodmorning/img30.png", "./images/goodmorning/img31.png", "./images/goodmorning/img32.png"], 
}
...
quickStart.addEventListener("click",function(){
    if ( !coverImageSet ) {
        coverImageArr = Array.from(Object.values(selectObj)).flat()
    }
    quizImageArr = []
    quizImageArr.push("./images/commonitems/img20.png")
...
function renderGame(arr){
    ...
    for ( let i = 0; i < gameType; i++ ) {
        if ( gameType === 16 ) {
            ...
            let currentImageBox = currentGrid.children[i]
            currentImageBox.innerHTML = `<img src="${displayArr[i]}">`
        } else if ( gameType === 20 ) {
            let currentGrid = document.querySelector(".twenty")
            let currentImageBox = currentGrid.children[i]
            currentImageBox.innerHTML = `<img src="${displayArr[i]}">`
        } else if ( gameType === 12 ) {
            let currentGrid = document.querySelector(".twelve")
            let currentImageBox = currentGrid.children[i]
            currentImageBox.innerHTML = `<img src="${displayArr[i]}">`
        }
    }
